...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Accordion; });\n/* harmony import */ var _configuration_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./configuration.js */ \"./js/modules/configuration.js\");\n\r\n\r\nclass Accordion {\r\n\r\n  constructor( container ) {\r\n\r\n    this.container = document.querySelector( container );\r\n    this.items     = this.container.querySelectorAll( 'dt' );\r\n  }\r\n\r\n  initialize() {\r\n\r\n    if ( this.items.length ) {\r\n\r\n      this.items[ 0 ].classList.add( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\r\n      this.items[ 0 ].nextElementSibling.classList.add( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\r\n\r\n      this.items.forEach( ( item ) => {\r\n\r\n        item.addEventListener( 'click', () => {\r\n          this.toggle( item );\r\n        } );\r\n      } );\r\n    }\r\n\r\n    return this;\r\n  }\r\n\r\n  toggle( item ) {\r\n\r\n    const description = item.nextElementSibling;\r\n\r\n    item.classList.toggle( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\r\n    description.classList.toggle( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\r\n  }  \r\n}\r\n\n\n//# sourceURL=webpack:///./js/modules/accordion.js?");

/***/ }),

/***/ "./js/modules/configuration.js":
/*!*************************************!*\
  !*** ./js/modules/configuration.js ***!
  \*************************************/
/*! exports provided: classActive, classOpen, windowHalfSize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"classActive\", function() { return classActive; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"classOpen\", function() { return classOpen; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"windowHalfSize\", function() { return windowHalfSize; });\nconst classActive = 'ativo';\nconst classOpen   = 'aberto';\nconst windowHalfSize = window.innerHeight * 0.6;\n\n\n//# sourceURL=webpack:///./js/modules/configuration.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return dropdownMenu; });\n/* harmony import */ var _configuration_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./configuration.js */ \"./js/modules/configuration.js\");\n/* harmony import */ var _events_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./events.js */ \"./js/modules/events.js\");\n\n\n\nfunction dropdownMenu() {\n\n  const menus  = document.querySelectorAll( '[data-ui-component=\"dropdown-menu\"]' );\n  const events = [ 'touchstart', 'click'];\n\n  function show( e ) {\n\n    e.preventDefault();\n\n    this.classList.add( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\n\n    _events_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].outside( this, events, () => {\n      this.classList.remove( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\n    } );\n  }\n\n  menus.forEach( ( menu ) => {\n\n    events.forEach( ( event ) => {\n      menu.addEventListener( event, show );\n    } );\n  } );\n}\n\n\n//# sourceURL=webpack:///./js/modules/dropdown-menu.js?");
...
/***/ "./js/modules/highlight-scroll.js":
/*!****************************************!*\
  !*** ./js/modules/highlight-scroll.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ScrollHighlight; });\n/* harmony import */ var _configuration_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./configuration.js */ \"./js/modules/configuration.js\");\n\n\nclass ScrollHighlight {\n\n    constructor( sections ) {\n\n        this.sections = document.querySelectorAll( sections );\n    }\n\n    initialize() {\n\n        this.bindings();\n\n        if ( this.sections.length ) {\n\n            this.getDistances();\n\n            document.addEventListener( 'scroll', this.highlight );\n            this.highlight();\n        }\n    }\n\n    getDistances() {\n\n        this.distances = [...this.sections].map( ( section ) => {\n            return {\n                element : section,\n                top     : ( section.offsetTop - _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"windowHalfSize\"] ),\n            };            \n        } );\n    }\n\n    highlight() {\n\n        this.distances.forEach( ( section ) => {\n\n            if ( window.pageYOffset > section.top ) {\n                section.element.classList.add( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\n            }\n            else if ( section.element.classList.contains( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] )  ) {\n                section.element.classList.remove( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\n            }\n        } );\n    }\n\n    discard() {\n        window.removeEventListener( this.highlight );\n    }\n\n    bindings() {\n        this.highlight = this.highlight.bind( this );\n    }\n}\n\n\n//# sourceURL=webpack:///./js/modules/highlight-scroll.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return mobileMenu; });\n/* harmony import */ var _configuration_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./configuration.js */ \"./js/modules/configuration.js\");\n/* harmony import */ var _events_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./events.js */ \"./js/modules/events.js\");\n\r\n\r\n\r\nfunction mobileMenu() {\r\n\r\n    const btn    = document.querySelector( '[data-ui-component=\"mobile-menu-button\"]' ),\r\n          list   = document.querySelector( '[data-ui-component=\"mobile-menu-list\"]' ),\r\n          events = [ 'click', 'touchstart' ];\r\n\r\n    function open( e ) {\r\n\r\n        btn.classList.add( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\r\n        list.classList.add( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\r\n\r\n        _events_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].outside( list, events, () => {\r\n\r\n            btn.classList.remove( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );\r\n            list.classList.remove( _configuration_js__WEBPACK_IMPORTED_MODULE_0__[\"classActive\"] );    \r\n        } );\r\n    }\r\n\r\n    if ( list ) {\r\n        \r\n        events.forEach( ( evento ) => {\r\n            btn.addEventListener( evento, open );\r\n        } );\r\n    }\r\n}\n\n//# sourceURL=webpack:///./js/modules/mobile-menu.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/smooth-scroll.js */ \"./js/modules/smooth-scroll.js\");\n/* harmony import */ var _modules_highlight_scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/highlight-scroll.js */ \"./js/modules/highlight-scroll.js\");\n/* harmony import */ var _modules_tab_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tab.js */ \"./js/modules/tab.js\");\n/* harmony import */ var _modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordion.js */ \"./js/modules/accordion.js\");\n/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal.js */ \"./js/modules/modal.js\");\n/* harmony import */ var _modules_tooltip_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/tooltip.js */ \"./js/modules/tooltip.js\");\n/* harmony import */ var _modules_dropdown_menu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/dropdown-menu.js */ \"./js/modules/dropdown-menu.js\");\n/* harmony import */ var _modules_mobile_menu_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/mobile-menu.js */ \"./js/modules/mobile-menu.js\");\n/* harmony import */ var _modules_opening_hours_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/opening-hours.js */ \"./js/modules/opening-hours.js\");\n/* harmony import */ var _modules_fetch_animals_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/fetch-animals.js */ \"./js/modules/fetch-animals.js\");\n/* harmony import */ var _modules_fetch_bitcoin_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/fetch-bitcoin.js */ \"./js/modules/fetch-bitcoin.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nObject(_modules_dropdown_menu_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])();\r\nObject(_modules_mobile_menu_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])();\r\nObject(_modules_opening_hours_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\r\nObject(_modules_fetch_animals_js__WEBPACK_IMPORTED_MODULE_9__[\"default\"])( '.grid-numbers', './js/api/animals-api.json' );\r\nObject(_modules_fetch_bitcoin_js__WEBPACK_IMPORTED_MODULE_10__[\"default\"])( '.bitcoin-donation', 'https://blockchain.info/ticker' );\r\n\r\nconst scrollHighlight = new _modules_highlight_scroll_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]( '[data-ui-component=\"scroll-highlight\"]' );\r\nscrollHighlight.initialize();\r\n\r\nconst tooltip = new _modules_tooltip_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"]( '[data-ui-component=\"tooltip\"]' );\r\ntooltip.initialize();\r\n\r\nconst modal = new _modules_modal_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"]( '[data-ui-component=\"modal\"]', '[data-ui-action=\"open-modal\"]', '[data-ui-action=\"close-modal\"]' );\r\nmodal.initialize();\r\n\r\nconst tab = new _modules_tab_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]( '[data-ui-component=\"tab-menu\"]' );\r\ntab.initialize();\r\n\r\nconst accordion = new _modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]( '[data-ui-component=\"accordion\"]' );\r\naccordion.initialize();\r\n\r\nconst smoothScroll = new _modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]( '[data-ui-component=\"scroll-menu\"] a[href^=\"#\"]' );\r\nsmoothScroll.initialize();\r\n\n\n//# sourceURL=webpack:///./js/script.js?");
